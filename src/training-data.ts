...
export const ENDGAME_POSITIONS: TrainingPosition[] = [
  ...
  { id: 'endgame-krk-1', title: 'Torre contra rei', category: 'Finais básicos', theme: 'corte do rei', fen: '7k/8/5K2/8/8/8/6R1/8 w - - 0 1', side: 'w', solution: 'g2g8', explanation: 'Use a torre para cortar linhas e empurrar o rei até a borda.' },
...
export const TACTICAL_POSITIONS: TrainingPosition[] = [
  { id: 'tactic-fork-1', title: 'Garfo de cavalo', category: 'Tática', theme: 'garfo', fen: 'r3k2r/ppp2ppp/2n5/3p4/8/2N5/PPP2PPP/R3K2R w KQkq - 0 1', side: 'w', solution: 'c3b5', explanation: 'Procure casas onde o cavalo ataque duas peças valiosas ao mesmo tempo.' },
  { id: 'tactic-pin-1', title: 'Cravada absoluta', category: 'Tática', theme: 'cravada', fen: '4k3/8/3n4/8/8/3B4/8/4R1K1 w - - 0 1', side: 'w', solution: 'd3b5', explanation: 'Uma peça cravada ao rei perde liberdade e pode se tornar alvo.' },
  { id: 'tactic-skewer-1', title: 'Espeto', category: 'Tática', theme: 'espeto', fen: '4k3/4q3/8/8/2B5/8/8/4K3 w - - 0 1', side: 'w', solution: 'c4b5', explanation: 'Ataque a peça mais valiosa na frente para ganhar a peça atrás.' },
  ...
  { id: 'tactic-discovery-1', title: 'Ataque descoberto', category: 'Tática', theme: 'ataque descoberto', fen: '4k3/8/8/3q4/8/2B5/3N4/4K3 w - - 0 1', side: 'w', solution: 'd2f3', explanation: 'Mover a peça bloqueadora pode liberar uma linha de ataque de outra peça.' },
